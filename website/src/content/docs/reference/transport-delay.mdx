...
import TransportDelayDiagram from '../../../components/TransportDelayDiagram.astro';
...
<TransportDelayDiagram />

The five stages are referred to by number throughout the rest of this page —
the fixes below are each labelled with the layer they target.
