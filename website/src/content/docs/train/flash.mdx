...
the reference rig's champion (`policy_weights_tmc2209_32.h`). Champions for
other rig configurations live alongside it, named
`policy_weights_<driver>_<microsteps>.h`; to promote a new champion, export to
the named header for your rig and commit it.
